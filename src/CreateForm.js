...
function SubmitCopy() {
  ...
  if (show) {
    return (
      ...
      <Alert  onClose={() => setShow(false)} >
        <Alert.Heading>Copy the link</Alert.Heading>
        <p>
          https://localhost:3000/answerform/123
        </p>
  ...
  return <Button variant="contained" onClick={() => setShow(true)} color="primary"  style={{fontSize:"14px"}}>Send</Button>;
 ...
 */}
                            ...
                            {ques.options.map((op, j)=>(
                                ...
                                <div>
                                    <input type="text" className="text_input" style={{fontSize:"13px",width:"50px"}} placeholder="Add other"></input>
                                    <Button size="small" onClick={()=>{addOption(i)}} style={{textTransform: 'none',color:"#00008c",fontSize:"13px",fontWeight:"600"}}>Add Option</Button>
                                </div>
                                } /> 
                                </div>
